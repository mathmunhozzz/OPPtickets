        ...
        <Card className="w-full max-w-sm travel-card travel-card-dark border-0 shadow-2xl">
          ...
          <CardContent className="px-6 pb-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 pr-12 border-slate-300 focus:border-primary focus:ring-primary/20"
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-slate-100 transition-colors"
                  >
                    {showPassword ? (
              ...
              <Button 
                type="submit" 
                className="w-full h-12 text-lg font-medium travel-gradient hover:opacity-90 transition-all duration-300 hover:scale-[1.02]" 
                disabled={loading}
              >
                {loading ? (
